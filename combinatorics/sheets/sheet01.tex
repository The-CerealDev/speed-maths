...
\SpeedMeta{Arrangements and the block method}{block method, digit constraints, grid counting}
...
\item How many rectangles (of any size, including squares) appear in a $3\times 3$ grid of unit squares?
