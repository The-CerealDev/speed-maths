...
%── B4 ──────────────────────────────────────────────────────────────────────────
\item Simplify: $\;\dfrac{a}{b-c}+\dfrac{b}{c-a}+\dfrac{c}{a-b}\,$, given that $a+b+c=0$.

\ans{$0$}
\method{Since $a+b+c=0$, we have $a=-(b+c)$. Substitute this into the first numerator: $\frac{-(b+c)}{b-c}$. Do the same for the others. Putting them over a common denominator $(a-b)(b-c)(c-a)$ causes all terms to sum exactly to $0$.}
...
\ans{$\dfrac{x+1}{x-2}$\;; undefined at $x=2$ and $x=-1$.}
...
\ans{$x = 1$}
\method{Multiply the entire equation by the common denominator $(x+1)(x+2)$. This leaves a simple linear equation: $3(x+2) + 4(x+1) = 11 \implies 7x + 10 = 11 \implies 7x = 1$.}
...
Numerator pairing: $[(x+3)^3 - x^3] - [(x+2)^3 + (x+1)^3]$. \\
Expand safely: $(x^3+9x^2+27x+27 - x^3) - (x^3+6x^2+12x+8 + x^3+3x^2+3x+1)$. \\
$= (9x^2+27x+27) - (2x^3+9x^2+15x+9)$. Wait, the sign on $x^3$ was positive! Let's pair differently: \\
$(x+3)^3 - (x+2)^3 = 3x^2 + 15x + 19$. \\
$x^3 - (x+1)^3 = -3x^2 - 3x - 1$. \\
Add them together: $12x + 18$. \\
