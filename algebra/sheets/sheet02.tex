...
\SpeedMeta{Paired products and denesting surds}{pairing factors, denesting radicals, biquadratic substitution}
...
\item The cubic $x^3 - 6x^2 + 11x - 6 = 0$ has roots $\alpha, \beta, \gamma$.
      Without solving it, find $\alpha^2+\beta^2+\gamma^2$ and $\alpha\beta\gamma$. \textit{\small(after TMUA 2017 Paper 1 Q5)}
...
\item Solve: $\;x^4-13x^2+36=0$. \textit{\small(after TMUA Practice Paper 1 Q1)}

\item Solve: $\;(x+1)(x+2)(x+3)(x+4)=24$.

\item Simplify: $\;\sqrt{6+2\sqrt{5}}$. \textit{\small(after TMUA 2018 Paper 1 Q1)}
