...
\SpeedMeta{Quadratic in disguise: substitution and symmetric sums}{difference of squares, quadratic in disguise, x + 1/x symmetry}
...
\item Solve: $\;x^4 - 5x^2 + 4 = 0$. \textit{\small(after TMUA Practice Paper 1 Q1)}
...
\item Factorise $\;x^4 + 4y^4\;$ over the integers. \textit{\small(after TMUA 2019 Paper 1 Q8)}
...
\item Without solving for $x$, find $x^2 + \dfrac{1}{x^2}$ given $x - \dfrac{1}{x} = \sqrt{5}$.
      Hence find $x^4 + \dfrac{1}{x^4}$. \textit{\small(after TMUA 2022 Paper 1 Q1)}
