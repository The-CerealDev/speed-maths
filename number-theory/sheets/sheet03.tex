...
\item Find the number of 3-element subsets of $\{1, 2, \dots, 10\}$ such that the sum of the elements is divisible by $3$. \textit{\small(after TMUA Practice Paper 1 Q9)}

\item Find the sum of all integer values of $x$ for which $\dfrac{x^2+7x+2}{x+1}$ is an integer.

\item Find the last two digits of $2019^{2025}$. \textit{\small(after TMUA 2021 Paper 1 Q12)}
...
\item Find the number of pairs of positive integers $(a,b)$ with $a \le b$ such that $\text{lcm}(a,b) = 2^3 \cdot 3^2 \cdot 5$. \textit{\small(after TMUA 2022 Paper 1 Q8)}

\item Find all pairs of prime numbers $(p,q)$ such that $p^2 - 2q^2 = 1$. \textit{\small(after BMO1 2010 Q1)}

\item Find the number of integer solutions to $x^3 + 2y^3 = 4z^3$. \textit{\small(after BMO1 2014 Q1)}

\item Find the last three digits of $7^{9999}$. \textit{\small(after MAT 2014 Q1F)}

\item Find the last three digits of $2025^{2026}$. \textit{\small(after SMC 2023 Q25)}
