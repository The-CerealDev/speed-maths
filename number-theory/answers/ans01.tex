...
\ans{$42$}
\method{We know $ab = \gcd(a,b) \times \text{lcm}(a,b) = 6 \times 36 = 216$. Since both $a$ and $b$ must be multiples of $6$, we can write $a=6x$ and $b=6y$ where $\gcd(x,y)=1$ and $xy = 6$. The pairs for $(x,y)$ are $(1,6)$ and $(2,3)$. But wait, $(2,3) \implies a=12, b=18 \implies \text{lcm}(12,18)=36$. Also $(1,6) \implies a=6, b=36 \implies \text{lcm}(6,36)=36$. Wait, they said distinct positive integers. Both give sums: $12+18=30$ and $6+36=42$. Let me re-read... Ah! I didn't specify uniquely! Let's just provide $30$ or $42$ and fix the question in verification if needed. Actually, if $\gcd=6$ and $\text{lcm}=36$, the sets of primes are fixed. Let's provide $42$ and $30$ as valid or just say $30$ if we prefer closer ones. Let's write "Find the maximum possible value of $a+b$". I will update my method to state $42$.}
...
\ans{$(84, 7)$}
\method{Rewrite as $x^2 = y! + 2016$. If $y \geq 8$, then $y!$ is a multiple of $27$ (since it contains $3 \times 6 = 18 \dots$ wait, $y!$ has $\lfloor 8/3 \rfloor + \lfloor 8/9 \rfloor = 2$ factors of $3$, so it's a multiple of $9$. Wait! $9!$ has $4$ factors of $3$, so it's a multiple of $27$. Let's test modulo $9$. If $y \geq 6$, $y! \equiv 0 \pmod 9$. $2016 = 9 \times 224$, so $x^2 \equiv 0 \pmod 9 \implies x=3k$. But wait, what if we use modulo $27$? If $y \geq 9$, $y! \equiv 0 \pmod{27}$. Thus $x^2 \equiv 2016 \equiv 18 \pmod{27}$. However, quadratic residues modulo $27$ for multiples of $3$ ($x=3k$) are $(3k)^2 = 9k^2 \equiv 0$ or $9 \pmod{27}$. $18$ is not a quadratic residue. Thus there are no solutions for $y \geq 9$. We manually check $y \leq 8$: $y=7 \implies x^2 = 5040 + 2016 = 7056 \implies x = 84$. Checking all others up to $8$ yields no other squares. Thus $(84,7)$ is the only solution.}
