...
\inv{\textit{\small(after TMUA 2020 Paper 2 Q1)} How does this relate to Wason's Selection Task in logic?}
...
\inv{\textit{\small(after TMUA 2017 Paper 2 Q6)} Which other integer remainders cannot be quadratic residues?}
...
\ans{E) I and II only}
\method{\textit{\small(after TMUA 2018 Paper 2 Q3)} \\
I: $41^2+41+41 = 41(41+1+1) = 41 \times 43$, composite. So I is true.\\
...
\ans{True}
\method{\textit{\small(after SMC 2019 Q16)} Proof: Any positive integer $n$ can be written as $3k$, $3k+1$, or $3k+2$ for some integer $k \ge 0$.\\
...
\method{\textit{\small(after TMUA 2021 Paper 2 Q8)} \\
(a) For $n=2$, prime $3 \in (2,4)$. For $n=3$, prime $5 \in (3,6)$. For $n=4$, prime $5 \in (4,8)$. For $n=5$, prime $7 \in (5,10)$. \\
