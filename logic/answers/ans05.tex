...
\SpeedTitleBlock{Answers: Logic Drill \#5}{David Akinyele-Aje}
...
\SpeedClosing{``A wrong proof that reads well is far more dangerous than one that does not.
Today's all read well.''}
