...
\SpeedMeta{Binomial expansion, and Pascal's triangle as a sequence}{binomial expansion, Pascal's triangle, generalised binomial series}
...
\item[B)] No simple closed form exists.
...
\item[D)] Expansion is not possible.
\end{itemize}
...
\item[D)] No such identity exists.
\end{itemize}
