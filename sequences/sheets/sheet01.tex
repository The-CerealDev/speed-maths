...
\SpeedTitleBlock{Daily Sequences Drill \#1}{The-CerealDev}
\SpeedMeta{Arithmetic sequences, and the sum as a quadratic in n}{nth-term formula, arithmetic series sum, sum as a quadratic}
...
\SpeedClosing{``An AP is linear in $n$; its sum is quadratic in $n$.
Most of the errors today will be confusing the two.''}
