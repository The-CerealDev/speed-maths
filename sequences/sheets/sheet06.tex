...
\begin{itemize}
\item[A)] Alice writes $6$, Bob writes $18$ repeatedly.
...
\item[B)] At most one candidate for each $k$, finitely many total.
...
\begin{itemize}
\item[A)] Finite constraints prevent infinite tightening conditions.
