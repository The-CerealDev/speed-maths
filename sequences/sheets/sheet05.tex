...
\SpeedMeta{Monotonicity, bounds and fixed points}{monotonicity, boundedness, fixed points, floor and ceiling sequences}
...
\begin{itemize}
\item[A)] Increasing and bounded above by $2$.
...
\begin{itemize}
\item[A)] Decreasing and bounded below by $2$.
...
\SpeedClosing{``A sequence that is bounded and monotonic converges.
A student who is bounded and monotonic does not.''}
