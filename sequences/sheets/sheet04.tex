...
\begin{itemize}
\item[A)] The AP toolkit.
\item[B)] The characteristic-equation toolkit.
\item[C)] Both give the same closed form.
...
\item[B)] Characteristic equation with a particular solution.
...
\begin{itemize}
\item[A)] The sequence oscillates in sign while its magnitude grows like $2^n$.
