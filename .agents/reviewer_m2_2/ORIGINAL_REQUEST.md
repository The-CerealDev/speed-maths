...
You are the second Reviewer. Your objective is to independently review the verification scripts generated for Combinatorics worksheets 02, 03, and 04:
...
Write your review report in `/home/cereal-dev/Documents/speed-maths/.agents/reviewer_m2_2/review.md` and send a message back to the parent (conversation ID: 3cfb6e73-dc42-472a-8f00-bafaa3912dd0) with your verdict (PASS/FAIL) and the report path.
