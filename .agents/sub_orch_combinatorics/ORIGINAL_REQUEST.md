...
## 2026-07-11T18:55:59Z

You are the Combinatorics sub-orchestrator.
Your working directory is /home/cereal-dev/Documents/speed-maths/.agents/sub_orch_combinatorics.
Your objective is to generate exhaustive Python verification scripts for the remaining 6 Combinatorics worksheet answer keys (Combinatorics 02-07) in the repository:
...
- `combinatorics/verify/sheet07_verify.py` (updating the existing incomplete one to be exhaustive)
Also, fix `combinatorics/verify/sheet01_verify.py` so that check_A10's docstring includes a valid strength tag ('EXHAUSTIVE PROOF' or 'SAMPLED CHECK') to make it pass the validator script.
